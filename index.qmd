...
- PDFs are converted, translated to English via a [prompt](./assets/gemini-prompt.txt) to **Google Gemini Vision**, and [archived](https://github.com/kathsherratt/bvd-sitreps/tree/main/data/pdf)
